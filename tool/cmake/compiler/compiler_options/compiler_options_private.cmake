set(warning_options_c_gnu -Wmissing-parameter-type -Wold-style-declaration -Wtraditional-conversion)
...
set(warning_options_c
    ...
    -Wpointer-sign
    # -Wdeclaration-missing-parameter-type -Wmissing-variable-declarations -Wtraditional -Wdeclaration-after-statement
)
...
set(warning_options_clang -Weverything)

set(compiler_options_cpp_flags_gnu -Wnoexcept -Wstrict-null-sentinel -Wuseless-cast)
...
set(warning_options_cpp
    ...
    # -Wno-global-constructors # causes warnings if you use static values -Wno-covered-switch-default
)
...
set(warning_options
    ...
    -Wreturn-type # Warn if a function returns a value whose type is incompatible with the function's declared return
                  # type
    ...
    -Wstrict-overflow=4 # Warn about cases where the compiler optimizes based on the assumption that signed overflow
                        # does not occur
...
set(c_dialect_options -funsigned-char # Let the type char be unsigned, like unsigned char
)
...
set(diagnostic_message_options -fdiagnostics-show-option -fdiagnostics-color
                               # -fdiagnostics-plain-output # Disabled: conflict with clang-tidy
)

set(developper_options_gnu -Wstack-usage=256)

set(developper_options "$<$<COMPILE_LANG_AND_ID:C,GNU>:${developper_options_gnu}>"
                       "$<$<COMPILE_LANG_AND_ID:CXX,GNU>:${developper_options_gnu}>" -fstack-usage)

set(optimization_options -fno-delete-null-pointer-checks -ftrivial-auto-var-init=zero -fno-strict-aliasing)

set(instrumentation_options # -fcf-protection=full # Enable control flow protection
)
...
set(compiler_options_arm -mbranch-protection=standard # supported only on armv8-m.main or later.
)
